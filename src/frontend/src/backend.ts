...
export class Backend implements backendInterface {
    ...
    async addEmployee(arg0: AddEmployeePayload): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAttendanceHistory(arg0: string): Promise<Array<AttendanceEntry>> {
        if (this.processError) {
            try {
    ...
    async getCallerEmployeeId(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerEmployeeId();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCallerEmployeeName(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerEmployeeName();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMarkToday(arg0: string, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.getMarkToday(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markAttendance(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async overrideAttendance(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.overrideAttendance(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async registerEmployeeMapping(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerEmployeeMapping(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeEmployee(arg0: string): Promise<void> {
        if (this.processError) {
            try {
